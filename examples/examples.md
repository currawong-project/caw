...
`tracer`   | Trace configuration: `{  trace_cnt:1024, msg_cnt: 1024000, enable_fl:false, activate_fl:false, out_fname:"tracer" }`
           ...
           | `enable_fl` = Enable the tracer. Set to 'false' for release build.
           | `activate_fl` = Start/Stop recording of traces.
           | `out_fname` = Tracer output file name. File format:`"seconds,nanosecs,app_trace_id,event_id,user0,user1"`
